...
setOpen(false);
  ...
  className="cursor-pointer bg-[#0066FF] hover:bg-[#3385FF] w-10 sm:w-auto flex items-center justify-center px-2 py-1"
>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2 ">
            ...
            <textarea
              ...
              className="w-full bg-[#E5F0FF] rounded-md border   px-3 py-2 text-sm resize-none h-24"
            />
          </div>
...
{/* Status */}
          <div className="space-y-2">
            ...
            <select
              ...
              className=" w-full rounded-md border bg-[#E5F0FF]  border-input  px-3 py-2 text-sm  cursor-pointer ">
          ...
          <div className="space-y-3 ">
            ...
            {form.subtasks.map((subtask) => (
              <div key={subtask.id} className="flex items-center gap-2 ">
                <Input value={subtask.title} readOnly className="bg-[#E5F0FF]  " />
                <Button
                  type="button"
                  variant="ghost"
                  size="icon"
          ...
          <DialogFooter className="gap-3">
            ...
            <Button type="submit" className="bg-[#0066FF] hover:bg-[#3385FF] cursor-pointer ">Create Task</Button> 
